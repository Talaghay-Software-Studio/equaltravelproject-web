    ...
    return (
      <Layout topMargin={true} appBarStyle="primary">
        ...
        >
          ...
          <div
            className={`${compStyles.emphasizeText} ${compStyles.bottomSpacing}`}
          >
          ...
          <div className={`${compStyles.bottomSpacing}`}>
            ...
            <div>
              <ul>
                <li>
                  <span
                    className={`${compStyles.emphasizeText}`}
                  >{`Consent`}</span>
          ...
          <div className={`${compStyles.bottomSpacing}`}>
            ...
            <div className={`${compStyles.bottomSpacing}`}>
              <div
                className={`${compStyles.emphasizeText}`}
              >{`California, Colorado, Connecticut, Virginia, and Utah each provide their state residents with rights to:`}</div>
              <ul>
            ...
            <div className={`${compStyles.bottomSpacing}`}>
              <div
                className={`${compStyles.emphasizeText}`}
              >{`California, Colorado, Connecticut, and Virginia also provide their state residents with rights to:`}</div>
              <ul>
          ...
          <div className={`${compStyles.bottomSpacing}`}>
            <Typography
              classes={{ root: compStyles.pageSubtitle }}
            >{`CALIFORNIA’S “SHINE THE LIGHT” ACT`}</Typography>
            <div>
          ...
          <div className={`${compStyles.bottomSpacing}`}>
            <Typography
              classes={{ root: compStyles.pageSubtitle }}
            >{`DO NOT TRACK SIGNALS`}</Typography>
            <div className={`${compStyles.bottomSpacing}`}>
          ...
          <div className={`${compStyles.bottomSpacing}`}>
            <Typography
              classes={{ root: compStyles.pageSubtitle }}
            >{`PRIVACY POLICY UPDATES`}</Typography>
            <div>
